...
- 排序
  ...
  - 选择排序
    ...
    - [堆排序](sort/heapsort.go)&ensp;&emsp;&emsp;[页内跳转](#4-heapsort-堆排序)
  - 交换排序
    - [冒泡排序](sort/bubblesort.go)&emsp;&emsp;[页内跳转](#5-bubblesort-冒泡排序)
    - [快速排序](sort/quicksort.go)&emsp;&emsp;[页内跳转](#6-quicksort-快速排序)
  - [归并排序](sort/mergesort.go)&emsp;&emsp;&emsp;[页内跳转](#7-mergesort-归并排序)
  - [基数排序](sort/radixsort.go)&emsp;&emsp;&emsp;[页内跳转](#8-radixsort-基数排序)
