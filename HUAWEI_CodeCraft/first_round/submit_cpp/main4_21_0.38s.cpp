...
int ans6_offest = 0;
int ans7_offest = 0;
char ans3_buf[500000*3*7];
char ans4_buf[500000*4*7];
char ans5_buf[1000000*5*7];
char ans6_buf[2000000*6*7];
char ans7_buf[3000000*7*7];
...
inline int int2str(char *str,int num)
    {
        int count = 0;
        char temp[7];
        do{
